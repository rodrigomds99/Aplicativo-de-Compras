...
class Login(Screen):
    ...
    def Logged(self):
        ...
        self.sql.cursor.execute("""
            SELECT * FROM Clientes WHERE Username = ? AND Password = ?""", (self.usernameCad, self.passwordCad))
        ...
        try:
            ...
            elif (self.usernameCad == "gerenteapp" and self.passwordCad == "gerente123"):
                messagebox.showinfo(title="Estado do Login", message="Gerente Logado com Sucesso!!")
                self.screen.destroy()  # Fecha a tela atual
